<?php
	...
	// for single post
	}else if( is_single() && (in_array(get_post_type(), array('post', 'tour')) || in_array(get_post_type(), array('post', 'hostal')))){
	...
	if( (empty($post_option['enable-page-title']) || $post_option['enable-page-title'] == 'enable') && (!empty($page_title) || !empty($page_caption)) ){	
		...
		if( !empty($page_caption) ){
			echo '<div class="traveltour-page-caption" ' . gdlr_core_esc_style(array(
